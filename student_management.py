    ...
    while True:
        try: 
            ...
            while True:        
                ...
                if grade.isnumeric():
                    print("Grade cannot be a number. Please try again.")
                else:
                    break
            while True:        
                subjects = input("Enter subjects:\n")
                if subjects.isnumeric():
                    print("Subjects cannot be numbers. Please try again.")
                else:
                    break    
            add(students, id, name, age, grade, subjects)
            print("Student added scuccessfully. Please insert your choice.")
            break
...
def update_student(student, id, updates):
    for student in students:
        if student["id"] == id:
